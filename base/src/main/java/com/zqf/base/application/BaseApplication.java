package com.zqf.base.application;
...
import com.zqf.base.greendao.MySQLiteOpenHelper;
import com.zqf.base.util.utils_blankj.ApplicationUtils;
import com.zqf.base.util.utils_blankj.Utils;
...
//        params.put("commonParamsKey1", "这里支持中文参数");//param支持中文,直接传,不要自己编码
        ...
        OkGo.getInstance().init(this)                           //必须调用初始化
                ...
                .setCacheTime(CacheEntity.CACHE_NEVER_EXPIRE)   //全局统一缓存时间，默认永不过期，可以不传  设置为1天
