...
public class NestedTouchScrollingLayout extends FrameLayout implements NestedScrollingParent {
    ...
    public void expand(final Runnable runnable, int duration) {
    ...
    public void peek(int offset, final Runnable runnable, int duration) {
    ...
    public void hiden(final Runnable runnable, int duration) {
    ...
    public void hiden(int offset, final Runnable runnable, int duration) {
        recover(offset, new Runnable() {
            @Override
            public void run() {
                mShowState = ShowState.HIDE;
